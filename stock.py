#PART 1: Create the stores item names and stock names
items = ["pencil","eraser","notebook","sharpener","glue"]
stock_counts = [12,0,8,5,3]


#PART 2: Pair items with stock counts into dictionary
...
#PART 4: ask the shopper what they want to buy
...
markup = int(input("Enter the markup amount ro add to every price:"))

#PART 7: Apply the markup to every price using map()
marked_up_prices = list(map(lambda p: p+ markup,prices))
print("Mark up Prices:",marked_up_prices)

#PART 8: find the mark up price of the chosen item
...
#PART 9: Reduce the stop count after the purchase
